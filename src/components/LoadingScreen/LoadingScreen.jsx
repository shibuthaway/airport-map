...
const PHASES = [
  'Initialising terminal map...',
  'Loading floor layouts...',
  'Mapping Gates 19 – 24...',
  'Calibrating baggage carousels...',
  'Ready.',
];
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setProgress(prev => {
        ...
        // Advance phase text at quarter milestones
        const pct = Math.min(next, 100);
        setPhaseIdx(Math.min(Math.floor(pct / 25), PHASES.length - 1));
        if (pct >= 100) {
          clearInterval(timer);
      ...
      {visible && (
        ...
        >
          ...
          <div className="relative mb-10 flex items-center justify-center">
            ...
            {/* AAI emblem placeholder — plane icon in a circle */}
            <motion.div
