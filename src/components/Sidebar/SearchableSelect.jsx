...
/**
 * SearchableSelect
 * - Mobile: full-screen overlay rendered via a fixed overlay (no portal needed)
 * - Desktop: dropdown under the trigger
 */
export default function SearchableSelect({
  ...
  return (
    <div className="relative flex-1 min-w-0">
      ...
      {/* ── MOBILE: Fixed full-screen overlay (bypasses any parent overflow/transform) ── */}
      {isMobile && isControlledOpen && (
        <div className="fixed inset-0 z-[9999] flex flex-col pointer-events-auto">
          ...
          {/* Bottom sheet */}
          <div
            className="relative mt-auto mx-3 mb-[72px] bg-white dark:bg-slate-900 rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-slate-200/50 dark:border-slate-800/50"
